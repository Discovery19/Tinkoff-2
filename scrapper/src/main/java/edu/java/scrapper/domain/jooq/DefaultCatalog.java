...
@SuppressWarnings({"all", "unchecked", "rawtypes", "this-escape"}) public class DefaultCatalog extends CatalogImpl {
    ...
    @Override @NotNull public final List<Schema> getSchemas() {
