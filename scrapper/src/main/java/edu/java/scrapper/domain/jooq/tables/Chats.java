...
@SuppressWarnings({"all", "unchecked", "rawtypes", "this-escape"}) public class Chats extends TableImpl<ChatsRecord> {
     ...
     */
    @Override @NotNull public Class<ChatsRecord> getRecordType() {
    ...
    @Override @NotNull public UniqueKey<ChatsRecord> getPrimaryKey() {
        return Keys.CONSTRAINT_3;
    }

    @Override @NotNull public Chats as(String alias) {
        return new Chats(DSL.name(alias), this);
    }

    @Override @NotNull public Chats as(Name alias) {
        return new Chats(alias, this);
    }

    @Override @NotNull public Chats as(Table<?> alias) {
     ...
     * Rename this table
     */
    @Override @NotNull public Chats rename(String name) {
     ...
     * Rename this table
     */
    @Override @NotNull public Chats rename(Name name) {
     ...
     * Rename this table
     */
    @Override @NotNull public Chats rename(Table<?> name) {
