...
public class Links extends TableImpl<LinksRecord> {
    ...
    /**
     * The column <code>LINKS.DESCRIPTION</code>.
     */
    public final TableField<LinksRecord, String> DESCRIPTION =
        createField(DSL.name("DESCRIPTION"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>LINKS.UPDATED_AT</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("UPDATED_AT"),
     ...
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_CHECKED = createField(DSL.name("LAST_CHECKED"),
        SQLDataType.TIMESTAMPWITHTIMEZONE(6)
            .defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)),
        this,
        ""
    ...
    /**
     * The column <code>LINKS.OPEN_ISSUES</code>.
     */
    public final TableField<LinksRecord, Integer> OPEN_ISSUES =
        createField(DSL.name("OPEN_ISSUES"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>LINKS.ANSWER_COUNT</code>.
     */
    public final TableField<LinksRecord, Integer> ANSWER_COUNT =
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super Long, ? super String, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super Integer, ? super Integer, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function7<? super Long, ? super String, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super Integer, ? super Integer, ? extends U> from
    ) {
